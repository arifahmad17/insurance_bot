...
class ActionHelloWorld(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message(text="Hello World!")
        DataUpdate(tracker.get_slot("name"),tracker.get_slot("registration_date"),tracker.get_slot("driving_license"),tracker.get_slot("license_plate"),tracker.get_slot("types"))
        dispatcher.utter_message(text="Monthly payment of 100")
